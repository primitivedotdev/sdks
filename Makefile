...
.PHONY: cli-install cli-test cli-check cli-build cli-smoke cli-tarball-isolation cli-coverage rust-cli-generate rust-cli-manifest-bytewise rust-cli-help-snapshots-bytewise rust-cli-check-generated rust-cli-check rust-cli-doc rust-cli-package rust-cli-build rust-cli-release-build rust-cli-dist rust-cli-smoke rust-cli-release-smoke rust-cli-linux-portability-smoke rust-cli-archive-smoke rust-cli-windows-archive-smoke rust-cli-install-smoke rust-cli-live-smoke rust-cli-live-smoke-no-key rust-cli-script-check rust-cli-release-platform-check rust-cli-full-check rust-cli-ci-check cli-command-surface-parity cli-operation-coverage cli-help-parity cli-response-matrix cli-archive-parity cli-parity
...
rust-cli-smoke: rust-cli-build
	...
	grep -q -- 'primitive/' "$$smoke_dir/prim-version.txt" && \
...
rust-cli-script-check:
	...
	node --check scripts/run-cli-response-matrix.mjs
...
cli-response-matrix: cli-command-surface-parity cli-operation-coverage rust-cli-build
	node scripts/run-cli-response-matrix.mjs --node-bin "$${NODE_CLI_BIN:-node $(CURDIR)/cli-node/bin/run.js}" --rust-bin "$${RUST_CLI_BIN:-$(CURDIR)/cli-rust/target/debug/primitive}"
...
cli-parity: cli-help-parity cli-operation-coverage cli-response-matrix
