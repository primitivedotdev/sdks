...
// encodeFields encodes fields.
func (s *AgentOrgRef) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
var jsonFieldsNameOfAgentOrgRef = [2]string{
	0: "id",
	1: "name",
}
...
func (s *AgentOrgRef) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AgentOrgRef to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AgentOrgRef")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAgentOrgRef) {
					name = jsonFieldsNameOfAgentOrgRef[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *AgentSignupResendResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("email")
		e.Str(s.Email)
	}
	...
	{
		e.FieldStart("resend_after")
		e.Int(s.ResendAfter)
	}
	{
		e.FieldStart("verification_code_length")
		e.Int(s.VerificationCodeLength)
	}
}

var jsonFieldsNameOfAgentSignupResendResult = [4]string{
	0: "email",
	1: "expires_in",
	2: "resend_after",
	3: "verification_code_length",
}

// Decode decodes AgentSignupResendResult from json.
func (s *AgentSignupResendResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AgentSignupResendResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "resend_after":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"resend_after\"")
			}
		case "verification_code_length":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				v, err := d.Int()
				s.VerificationCodeLength = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"verification_code_length\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode AgentSignupResendResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAgentSignupResendResult) {
					name = jsonFieldsNameOfAgentSignupResendResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *AgentSignupStartResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("signup_token")
		e.Str(s.SignupToken)
	}
	{
		e.FieldStart("email")
...
var jsonFieldsNameOfAgentSignupStartResult = [5]string{
	0: "signup_token",
	1: "email",
	2: "expires_in",
	3: "resend_after",
	4: "verification_code_length",
}

// Decode decodes AgentSignupStartResult from json.
func (s *AgentSignupStartResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AgentSignupStartResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "signup_token":
			...
			if err := func() error {
				v, err := d.Str()
				s.SignupToken = string(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"signup_token\"")
			}
		case "email":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
		...
		return errors.Wrap(err, "decode AgentSignupStartResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAgentSignupStartResult) {
					name = jsonFieldsNameOfAgentSignupStartResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *AgentSignupVerifyResult) encodeFields(e *jx.Encoder) {
	{
...
var jsonFieldsNameOfAgentSignupVerifyResult = [13]string{
	0:  "api_key",
	1:  "key_id",
	2:  "key_prefix",
	3:  "access_token",
...
func (s *AgentSignupVerifyResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AgentSignupVerifyResult to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "orgs":
			...
			if err := func() error {
				s.Orgs = make([]AgentOrgRef, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem AgentOrgRef
		...
		return errors.Wrap(err, "decode AgentSignupVerifyResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAgentSignupVerifyResult) {
					name = jsonFieldsNameOfAgentSignupVerifyResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *AgentSignupVerifyResultAuthMethod) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AgentSignupVerifyResultAuthMethod to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
func (s *AgentSignupVerifyResultTokenType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AgentSignupVerifyResultTokenType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *CliLoginPollResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("api_key")
		e.Str(s.APIKey)
	}
...
func (s *CliLoginPollResult) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliLoginPollResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliLoginPollResult) {
					name = jsonFieldsNameOfCliLoginPollResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *CliLoginStartResult) encodeFields(e *jx.Encoder) {
	{
...
var jsonFieldsNameOfCliLoginStartResult = [6]string{
	0: "device_code",
	1: "user_code",
	2: "verification_uri",
...
func (s *CliLoginStartResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLoginStartResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliLoginStartResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliLoginStartResult) {
					name = jsonFieldsNameOfCliLoginStartResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CliLogoutBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CliLogoutBadRequest(unwrapped)
	return nil
}
...
func (s *CliLogoutForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutForbidden to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
...
// encodeFields encodes fields.
func (s *CliLogoutInput) encodeFields(e *jx.Encoder) {
	{
		if s.KeyID.Set {
			e.FieldStart("key_id")
			s.KeyID.Encode(e)
...
var jsonFieldsNameOfCliLogoutInput = [1]string{
	0: "key_id",
}
...
func (s *CliLogoutInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutInput to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliLogoutInput")
	}
...
func (s *CliLogoutNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
...
// encodeFields encodes fields.
func (s *CliLogoutOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfCliLogoutOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *CliLogoutOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliLogoutOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliLogoutOK) {
					name = jsonFieldsNameOfCliLogoutOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CliLogoutResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliLogoutResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliLogoutResult) {
					name = jsonFieldsNameOfCliLogoutResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CliLogoutUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliLogoutUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CliLogoutUnauthorized(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *CliSignupResendResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("email")
		e.Str(s.Email)
	}
...
var jsonFieldsNameOfCliSignupResendResult = [4]string{
	0: "email",
	1: "expires_in",
	2: "resend_after",
	3: "verification_code_length",
...
func (s *CliSignupResendResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliSignupResendResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliSignupResendResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliSignupResendResult) {
					name = jsonFieldsNameOfCliSignupResendResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *CliSignupStartResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("signup_token")
		e.Str(s.SignupToken)
	}
...
var jsonFieldsNameOfCliSignupStartResult = [5]string{
	0: "signup_token",
	1: "email",
	2: "expires_in",
	3: "resend_after",
...
func (s *CliSignupStartResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CliSignupStartResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliSignupStartResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliSignupStartResult) {
					name = jsonFieldsNameOfCliSignupStartResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *CliSignupVerifyResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("api_key")
		e.Str(s.APIKey)
	}
...
func (s *CliSignupVerifyResult) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CliSignupVerifyResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCliSignupVerifyResult) {
					name = jsonFieldsNameOfCliSignupVerifyResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *Conversation) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "messages":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				s.Messages = make([]ConversationMessage, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem ConversationMessage
					if err := elem.Decode(d); err != nil {
						return err
					}
...
// Encode implements json.Marshaler.
func (s *ConversationMessage) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ConversationMessage) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("role")
		s.Role.Encode(e)
	}
...
func (s *ConversationMessage) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ConversationMessage to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ConversationMessage")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfConversationMessage) {
					name = jsonFieldsNameOfConversationMessage[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ConversationMessage) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ConversationMessage) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes ConversationMessageDirection as json.
func (s ConversationMessageDirection) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ConversationMessageDirection from json.
func (s *ConversationMessageDirection) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ConversationMessageDirection to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch ConversationMessageDirection(v) {
	...
	default:
		*s = ConversationMessageDirection(v)
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s ConversationMessageDirection) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// Encode encodes ConversationMessageRole as json.
func (s ConversationMessageRole) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ConversationMessageRole from json.
func (s *ConversationMessageRole) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ConversationMessageRole to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch ConversationMessageRole(v) {
...
// MarshalJSON implements stdjson.Marshaler.
func (s ConversationMessageRole) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (s *CreateFunctionBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CreateFunctionBadRequest(unwrapped)
	return nil
}
...
func (s *CreateFunctionConflict) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionConflict to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CreateFunctionConflict(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *CreateFunctionCreated) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfCreateFunctionCreated = [2]string{
	0: "success",
	1: "data",
}
...
func (s *CreateFunctionCreated) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionCreated to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CreateFunctionCreated")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCreateFunctionCreated) {
					name = jsonFieldsNameOfCreateFunctionCreated[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *CreateFunctionInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("name")
		e.Str(s.Name)
	}
...
func (s *CreateFunctionInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "sourceMap":
			if err := func() error {
				s.SourceMap.Reset()
				if err := s.SourceMap.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		return errors.Wrap(err, "decode CreateFunctionInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCreateFunctionInput) {
					name = jsonFieldsNameOfCreateFunctionInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *CreateFunctionResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
func (s *CreateFunctionResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "deploy_status":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				if err := s.DeployStatus.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		return errors.Wrap(err, "decode CreateFunctionResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCreateFunctionResult) {
					name = jsonFieldsNameOfCreateFunctionResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CreateFunctionSecretBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionSecretBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CreateFunctionSecretBadRequest(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *CreateFunctionSecretCreated) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfCreateFunctionSecretCreated = [2]string{
	0: "success",
	1: "data",
}
...
func (s *CreateFunctionSecretCreated) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionSecretCreated to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CreateFunctionSecretCreated")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCreateFunctionSecretCreated) {
					name = jsonFieldsNameOfCreateFunctionSecretCreated[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *CreateFunctionSecretInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("key")
		e.Str(s.Key)
	}
...
var jsonFieldsNameOfCreateFunctionSecretInput = [2]string{
	0: "key",
	1: "value",
}
...
func (s *CreateFunctionSecretInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionSecretInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CreateFunctionSecretInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCreateFunctionSecretInput) {
					name = jsonFieldsNameOfCreateFunctionSecretInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CreateFunctionSecretNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionSecretNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CreateFunctionSecretNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *CreateFunctionSecretOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfCreateFunctionSecretOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *CreateFunctionSecretOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionSecretOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode CreateFunctionSecretOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfCreateFunctionSecretOK) {
					name = jsonFieldsNameOfCreateFunctionSecretOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CreateFunctionSecretUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionSecretUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CreateFunctionSecretUnauthorized(unwrapped)
	return nil
}
...
func (s *CreateFunctionUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CreateFunctionUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = CreateFunctionUnauthorized(unwrapped)
	return nil
}
...
func (s *DeleteFunctionBadGateway) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteFunctionBadGateway to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteFunctionBadGateway(unwrapped)
	return nil
}
...
func (s *DeleteFunctionNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteFunctionNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteFunctionNotFound(unwrapped)
	return nil
}
...
func (s *DeleteFunctionSecretBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteFunctionSecretBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteFunctionSecretBadRequest(unwrapped)
	return nil
}
...
func (s *DeleteFunctionSecretNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteFunctionSecretNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteFunctionSecretNotFound(unwrapped)
	return nil
}
...
func (s *DeleteFunctionSecretUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteFunctionSecretUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteFunctionSecretUnauthorized(unwrapped)
	return nil
}
...
func (s *DeleteFunctionUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteFunctionUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteFunctionUnauthorized(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *DiscardContentResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("discarded")
		e.Bool(s.Discarded)
	}
	{
		e.FieldStart("already_discarded")
		e.Bool(s.AlreadyDiscarded)
	}
}

var jsonFieldsNameOfDiscardContentResult = [2]string{
	0: "discarded",
	1: "already_discarded",
}
...
func (s *DiscardContentResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardContentResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "already_discarded":
			...
			if err := func() error {
				v, err := d.Bool()
				s.AlreadyDiscarded = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"already_discarded\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode DiscardContentResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfDiscardContentResult) {
					name = jsonFieldsNameOfDiscardContentResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *DiscardEmailContentBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardEmailContentBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DiscardEmailContentBadRequest(unwrapped)
	return nil
}
...
func (s *DiscardEmailContentForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardEmailContentForbidden to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DiscardEmailContentForbidden(unwrapped)
	return nil
}
...
func (s *DiscardEmailContentInternalServerError) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardEmailContentInternalServerError to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DiscardEmailContentInternalServerError(unwrapped)
	return nil
}
...
func (s *DiscardEmailContentNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardEmailContentNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DiscardEmailContentNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *DiscardEmailContentOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfDiscardEmailContentOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *DiscardEmailContentOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardEmailContentOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode DiscardEmailContentOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfDiscardEmailContentOK) {
					name = jsonFieldsNameOfDiscardEmailContentOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *DiscardEmailContentUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DiscardEmailContentUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DiscardEmailContentUnauthorized(unwrapped)
	return nil
}
...
// Encode implements json.Marshaler.
func (s *DkimSignature) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *DkimSignature) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("domain")
		e.Str(s.Domain)
	}
	...
	{
		e.FieldStart("aligned")
		e.Bool(s.Aligned)
	}
	{
		if s.KeyBits.Set {
			e.FieldStart("keyBits")
			s.KeyBits.Encode(e)
		}
	}
	{
...
var jsonFieldsNameOfDkimSignature = [6]string{
	0: "domain",
	1: "selector",
	2: "result",
	3: "aligned",
...
// Decode decodes DkimSignature from json.
func (s *DkimSignature) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DkimSignature to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "aligned":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"aligned\"")
			}
		case "keyBits":
			if err := func() error {
				s.KeyBits.Reset()
				if err := s.KeyBits.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"keyBits\"")
			}
		case "algo":
			if err := func() error {
				s.Algo.Reset()
		...
		return errors.Wrap(err, "decode DkimSignature")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfDkimSignature) {
					name = jsonFieldsNameOfDkimSignature[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *DkimSignature) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *DkimSignature) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
func (s *DownloadDomainZoneFileBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DownloadDomainZoneFileBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DownloadDomainZoneFileBadRequest(unwrapped)
	return nil
}
...
func (s *DownloadDomainZoneFileNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DownloadDomainZoneFileNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DownloadDomainZoneFileNotFound(unwrapped)
	return nil
}
...
func (s *DownloadDomainZoneFileUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DownloadDomainZoneFileUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DownloadDomainZoneFileUnauthorized(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *EmailAddress) encodeFields(e *jx.Encoder) {
	{
		if s.Name.Set {
			e.FieldStart("name")
			s.Name.Encode(e)
...
var jsonFieldsNameOfEmailAddress = [2]string{
	0: "name",
	1: "address",
}
...
func (s *EmailAddress) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode EmailAddress")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailAddress) {
					name = jsonFieldsNameOfEmailAddress[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// Encode implements json.Marshaler.
func (s *EmailAttachment) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *EmailAttachment) encodeFields(e *jx.Encoder) {
	{
		if s.Filename.Set {
	...
	}
	{
		if s.PartIndex.Set {
			...
			s.PartIndex.Encode(e)
		}
	}
}

var jsonFieldsNameOfEmailAttachment = [5]string{
	0: "filename",
	1: "content_type",
	2: "size_bytes",
	3: "sha256",
...
// Decode decodes EmailAttachment from json.
func (s *EmailAttachment) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailAttachment to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "part_index":
			if err := func() error {
				s.PartIndex.Reset()
				if err := s.PartIndex.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		return errors.Wrap(err, "decode EmailAttachment")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailAttachment) {
					name = jsonFieldsNameOfEmailAttachment[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *EmailAttachment) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *EmailAttachment) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *EmailAuth) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *EmailAuth) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("spf")
		e.Str(s.Spf)
	}
	...
	{
		if s.DmarcPolicy.Set {
			e.FieldStart("dmarcPolicy")
			s.DmarcPolicy.Encode(e)
		}
	}
	{
		if s.DmarcFromDomain.Set {
			e.FieldStart("dmarcFromDomain")
			s.DmarcFromDomain.Encode(e)
		}
	}
	{
		e.FieldStart("dmarcSpfAligned")
		e.Bool(s.DmarcSpfAligned)
	}
	{
		e.FieldStart("dmarcDkimAligned")
		e.Bool(s.DmarcDkimAligned)
	}
	{
		if s.DmarcSpfStrict.Set {
			e.FieldStart("dmarcSpfStrict")
			s.DmarcSpfStrict.Encode(e)
		}
	}
	{
		if s.DmarcDkimStrict.Set {
			e.FieldStart("dmarcDkimStrict")
			s.DmarcDkimStrict.Encode(e)
		}
	}
	{
		e.FieldStart("dkimSignatures")
		e.ArrStart()
		for _, elem := range s.DkimSignatures {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
...
var jsonFieldsNameOfEmailAuth = [9]string{
	0: "spf",
	1: "dmarc",
	2: "dmarcPolicy",
	3: "dmarcFromDomain",
...
// Decode decodes EmailAuth from json.
func (s *EmailAuth) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailAuth to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "dmarcPolicy":
			if err := func() error {
				s.DmarcPolicy.Reset()
				if err := s.DmarcPolicy.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dmarcPolicy\"")
			}
		case "dmarcFromDomain":
			if err := func() error {
				s.DmarcFromDomain.Reset()
				if err := s.DmarcFromDomain.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dmarcFromDomain\"")
			}
		case "dmarcSpfAligned":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				v, err := d.Bool()
				s.DmarcSpfAligned = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dmarcSpfAligned\"")
			}
		case "dmarcDkimAligned":
			requiredBitSet[0] |= 1 << 5
			if err := func() error {
				v, err := d.Bool()
				s.DmarcDkimAligned = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dmarcDkimAligned\"")
			}
		case "dmarcSpfStrict":
			if err := func() error {
				s.DmarcSpfStrict.Reset()
				if err := s.DmarcSpfStrict.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dmarcSpfStrict\"")
			}
		case "dmarcDkimStrict":
			if err := func() error {
				s.DmarcDkimStrict.Reset()
				if err := s.DmarcDkimStrict.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dmarcDkimStrict\"")
			}
		case "dkimSignatures":
			requiredBitSet[1] |= 1 << 0
			if err := func() error {
				s.DkimSignatures = make([]DkimSignature, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem DkimSignature
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.DkimSignatures = append(s.DkimSignatures, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"dkimSignatures\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode EmailAuth")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailAuth) {
					name = jsonFieldsNameOfEmailAuth[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *EmailAuth) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *EmailAuth) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// encodeFields encodes fields.
func (s *EmailSearchFacetBucket) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("value")
		s.Value.Encode(e)
	}
...
var jsonFieldsNameOfEmailSearchFacetBucket = [2]string{
	0: "value",
	1: "count",
}
...
func (s *EmailSearchFacetBucket) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailSearchFacetBucket to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode EmailSearchFacetBucket")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailSearchFacetBucket) {
					name = jsonFieldsNameOfEmailSearchFacetBucket[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *EmailSearchFacets) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("by_sender")
		e.ArrStart()
		for _, elem := range s.BySender {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
	...
	}
	{
		...
		e.ArrStart()
		for _, elem := range s.ByStatus {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
	{
		e.FieldStart("has_attachment")
		s.HasAttachment.Encode(e)
	}
}

var jsonFieldsNameOfEmailSearchFacets = [4]string{
	0: "by_sender",
	1: "by_domain",
	2: "by_status",
	3: "has_attachment",
...
func (s *EmailSearchFacets) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailSearchFacets to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "by_sender":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				s.BySender = make([]EmailSearchFacetBucket, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem EmailSearchFacetBucket
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.BySender = append(s.BySender, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"by_sender\"")
			}
		case "by_domain":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.ByDomain = make([]EmailSearchFacetBucket, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem EmailSearchFacetBucket
					if err := elem.Decode(d); err != nil {
						return err
		...
		case "by_status":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				s.ByStatus = make([]EmailSearchFacetBucket, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem EmailSearchFacetBucket
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.ByStatus = append(s.ByStatus, elem)
					return nil
				}); err != nil {
					return err
				}
		...
		case "has_attachment":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"has_attachment\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode EmailSearchFacets")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailSearchFacets) {
					name = jsonFieldsNameOfEmailSearchFacets[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *EmailSearchFacetsHasAttachment) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("true")
		e.Int(s.True)
	}
...
var jsonFieldsNameOfEmailSearchFacetsHasAttachment = [2]string{
	0: "true",
	1: "false",
}
...
func (s *EmailSearchFacetsHasAttachment) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailSearchFacetsHasAttachment to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode EmailSearchFacetsHasAttachment")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailSearchFacetsHasAttachment) {
					name = jsonFieldsNameOfEmailSearchFacetsHasAttachment[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *EmailSearchHighlights) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("subject")
		e.ArrStart()
		for _, elem := range s.Subject {
			e.Str(elem)
		}
		e.ArrEnd()
	}
...
var jsonFieldsNameOfEmailSearchHighlights = [2]string{
	0: "subject",
	1: "body",
}
...
func (s *EmailSearchHighlights) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailSearchHighlights to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "subject":
			...
			if err := func() error {
				...
				if err := d.Arr(func(d *jx.Decoder) error {
					...
					s.Subject = append(s.Subject, elem)
					return nil
				}); err != nil {
					return err
				}
		...
		return errors.Wrap(err, "decode EmailSearchHighlights")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailSearchHighlights) {
					name = jsonFieldsNameOfEmailSearchHighlights[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
var jsonFieldsNameOfEmailSearchMeta = [5]string{
	0: "total",
	1: "total_capped",
	2: "limit",
	3: "cursor",
...
func (s *EmailSearchMeta) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailSearchMeta to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "total_capped":
			...
			if err := func() error {
				v, err := d.Bool()
				s.TotalCapped = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"total_capped\"")
			}
		case "limit":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
		...
		return errors.Wrap(err, "decode EmailSearchMeta")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailSearchMeta) {
					name = jsonFieldsNameOfEmailSearchMeta[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *EmailSearchMetaSort) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EmailSearchMetaSort to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *EmailSearchResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
func (s *EmailSearchResult) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode EmailSearchResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [3]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEmailSearchResult) {
					name = jsonFieldsNameOfEmailSearchResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *FunctionDeployStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionDeployStatus to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *FunctionDetail) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
	...
	{
		if s.DeployError.Set {
			e.FieldStart("deploy_error")
			s.DeployError.Encode(e)
		}
	}
	{
		if s.DeployedAt.Set {
			e.FieldStart("deployed_at")
			s.DeployedAt.Encode(e, json.EncodeDateTime)
		}
	}
	{
		e.FieldStart("created_at")
...
func (s *FunctionDetail) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "deploy_error":
			if err := func() error {
				s.DeployError.Reset()
				if err := s.DeployError.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"deploy_error\"")
			}
		case "deployed_at":
			if err := func() error {
				s.DeployedAt.Reset()
				if err := s.DeployedAt.Decode(d, json.DecodeDateTime); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		return errors.Wrap(err, "decode FunctionDetail")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionDetail) {
					name = jsonFieldsNameOfFunctionDetail[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionListItem) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
func (s *FunctionListItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionListItem to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionListItem")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionListItem) {
					name = jsonFieldsNameOfFunctionListItem[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionLogRow) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
var jsonFieldsNameOfFunctionLogRow = [6]string{
	0: "id",
	1: "function_id",
	2: "level",
	3: "message",
...
func (s *FunctionLogRow) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionLogRow to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionLogRow")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionLogRow) {
					name = jsonFieldsNameOfFunctionLogRow[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *FunctionLogRowLevel) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionLogRowLevel to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields implements json.Marshaler.
func (s FunctionLogRowMetadata) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
func (s *FunctionLogRowMetadata) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionLogRowMetadata to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem jx.Raw
		...
		return errors.Wrap(err, "decode FunctionLogRowMetadata")
	}
...
// encodeFields encodes fields.
func (s *FunctionSecretListItem) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("key")
		e.Str(s.Key)
	}
...
var jsonFieldsNameOfFunctionSecretListItem = [5]string{
	0: "key",
	1: "managed",
	2: "description",
	3: "created_at",
...
func (s *FunctionSecretListItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionSecretListItem to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionSecretListItem")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionSecretListItem) {
					name = jsonFieldsNameOfFunctionSecretListItem[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionSecretWriteResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("key")
		e.Str(s.Key)
	}
...
var jsonFieldsNameOfFunctionSecretWriteResult = [4]string{
	0: "key",
	1: "created_at",
	2: "updated_at",
	3: "created",
...
func (s *FunctionSecretWriteResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionSecretWriteResult to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionSecretWriteResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionSecretWriteResult) {
					name = jsonFieldsNameOfFunctionSecretWriteResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionTestRun) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
	...
	{
		e.FieldStart("inbound_domain")
		e.Str(s.InboundDomain)
	}
	{
		e.FieldStart("to")
		e.Str(s.To)
	...
	{
		e.FieldStart("poll_since")
		json.EncodeDateTime(e, s.PollSince)
	}
	{
		e.FieldStart("created_at")
		json.EncodeDateTime(e, s.CreatedAt)
	...
	{
		e.FieldStart("send_error")
		s.SendError.Encode(e)
	}
}

var jsonFieldsNameOfFunctionTestRun = [10]string{
	0: "id",
	1: "function_id",
	2: "inbound_domain",
	3: "to",
...
func (s *FunctionTestRun) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRun to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "inbound_domain":
			...
			if err := func() error {
				v, err := d.Str()
				s.InboundDomain = string(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"inbound_domain\"")
			}
		case "to":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
		...
		case "poll_since":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"poll_since\"")
			}
		case "created_at":
			requiredBitSet[0] |= 1 << 7
			if err := func() error {
		...
		case "send_error":
			requiredBitSet[1] |= 1 << 1
			if err := func() error {
				if err := s.SendError.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"send_error\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode FunctionTestRun")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRun) {
					name = jsonFieldsNameOfFunctionTestRun[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionTestRunDelivery) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		e.Str(s.ID)
	}
	...
	{
		e.FieldStart("endpoint_url")
		json.EncodeURI(e, s.EndpointURL)
	}
	{
		e.FieldStart("status")
		s.Status.Encode(e)
...
var jsonFieldsNameOfFunctionTestRunDelivery = [11]string{
	0:  "id",
	1:  "endpoint_id",
	2:  "endpoint_url",
	3:  "status",
...
func (s *FunctionTestRunDelivery) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunDelivery to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionTestRunDelivery")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunDelivery) {
					name = jsonFieldsNameOfFunctionTestRunDelivery[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionTestRunDeliveryEndpoint) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
	...
	{
		e.FieldStart("is_current_function")
		e.Bool(s.IsCurrentFunction)
	}
}

var jsonFieldsNameOfFunctionTestRunDeliveryEndpoint = [8]string{
	0: "id",
	1: "kind",
	2: "function_id",
	3: "function_name",
...
func (s *FunctionTestRunDeliveryEndpoint) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "is_current_function":
			requiredBitSet[0] |= 1 << 7
			if err := func() error {
				v, err := d.Bool()
				s.IsCurrentFunction = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"is_current_function\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode FunctionTestRunDeliveryEndpoint")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunDeliveryEndpoint) {
					name = jsonFieldsNameOfFunctionTestRunDeliveryEndpoint[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *FunctionTestRunDeliveryStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunDeliveryStatus to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch FunctionTestRunDeliveryStatus(v) {
	...
	default:
		*s = FunctionTestRunDeliveryStatus(v)
	}
...
// encodeFields encodes fields.
func (s *FunctionTestRunInboundEmail) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
var jsonFieldsNameOfFunctionTestRunInboundEmail = [10]string{
	0: "id",
	1: "status",
	2: "received_at",
	3: "from",
	...
	5: "subject",
	6: "webhook_status",
	7: "webhook_attempt_count",
	8: "webhook_last_status_code",
	9: "webhook_last_error",
}

// Decode decodes FunctionTestRunInboundEmail from json.
func (s *FunctionTestRunInboundEmail) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunInboundEmail to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionTestRunInboundEmail")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunInboundEmail) {
					name = jsonFieldsNameOfFunctionTestRunInboundEmail[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionTestRunOutboundRequest) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
	...
	{
		e.FieldStart("webhook_delivery_id")
		s.WebhookDeliveryID.Encode(e)
	}
	{
		e.FieldStart("email_id")
		s.EmailID.Encode(e)
...
var jsonFieldsNameOfFunctionTestRunOutboundRequest = [14]string{
	0:  "id",
	1:  "function_id",
	2:  "webhook_delivery_id",
	3:  "email_id",
	4:  "endpoint_id",
	5:  "method",
	6:  "url",
...
func (s *FunctionTestRunOutboundRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunOutboundRequest to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "webhook_delivery_id":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				if err := s.WebhookDeliveryID.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"webhook_delivery_id\"")
			}
		case "email_id":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
		...
		return errors.Wrap(err, "decode FunctionTestRunOutboundRequest")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunOutboundRequest) {
					name = jsonFieldsNameOfFunctionTestRunOutboundRequest[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionTestRunReply) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
var jsonFieldsNameOfFunctionTestRunReply = [6]string{
	0: "id",
	1: "status",
	2: "to",
	3: "subject",
...
func (s *FunctionTestRunReply) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunReply to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionTestRunReply")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunReply) {
					name = jsonFieldsNameOfFunctionTestRunReply[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *FunctionTestRunSend) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
var jsonFieldsNameOfFunctionTestRunSend = [5]string{
	0: "id",
	1: "status",
	2: "queue_id",
	3: "created_at",
...
func (s *FunctionTestRunSend) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunSend to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FunctionTestRunSend")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunSend) {
					name = jsonFieldsNameOfFunctionTestRunSend[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *FunctionTestRunState) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunState to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *FunctionTestRunTrace) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("state")
		s.State.Encode(e)
	}
	{
		e.FieldStart("test_run")
		s.TestRun.Encode(e)
	}
	{
		e.FieldStart("test_send")
		s.TestSend.Encode(e)
	}
	{
		e.FieldStart("inbound_email")
		s.InboundEmail.Encode(e)
	}
	{
	...
	{
		e.FieldStart("outbound_requests")
		e.ArrStart()
		for _, elem := range s.OutboundRequests {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
...
var jsonFieldsNameOfFunctionTestRunTrace = [8]string{
	0: "state",
	1: "test_run",
	2: "test_send",
	3: "inbound_email",
...
func (s *FunctionTestRunTrace) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FunctionTestRunTrace to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "test_run":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				if err := s.TestRun.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"test_run\"")
			}
		case "test_send":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				if err := s.TestSend.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"test_send\"")
			}
		case "inbound_email":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				if err := s.InboundEmail.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"inbound_email\"")
			}
		case "deliveries":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				s.Deliveries = make([]FunctionTestRunDelivery, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem FunctionTestRunDelivery
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		case "outbound_requests":
			requiredBitSet[0] |= 1 << 5
			if err := func() error {
				s.OutboundRequests = make([]FunctionTestRunOutboundRequest, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem FunctionTestRunOutboundRequest
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.OutboundRequests = append(s.OutboundRequests, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"outbound_requests\"")
			}
		case "logs":
			requiredBitSet[0] |= 1 << 6
			if err := func() error {
				s.Logs = make([]FunctionLogRow, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem FunctionLogRow
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		case "replies":
			requiredBitSet[0] |= 1 << 7
			if err := func() error {
				s.Replies = make([]FunctionTestRunReply, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem FunctionTestRunReply
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Replies = append(s.Replies, elem)
		...
		return errors.Wrap(err, "decode FunctionTestRunTrace")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFunctionTestRunTrace) {
					name = jsonFieldsNameOfFunctionTestRunTrace[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// Decode decodes GetConversationBadRequest from json.
func (s *GetConversationBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetConversationBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetConversationBadRequest(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *GetConversationBadRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetConversationBadRequest) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode implements json.Marshaler.
func (s *GetConversationOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *GetConversationOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetConversationOK = [2]string{
	0: "success",
	1: "data",
}

// Decode decodes GetConversationOK from json.
func (s *GetConversationOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetConversationOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetConversationOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetConversationOK) {
					name = jsonFieldsNameOfGetConversationOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *GetConversationOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetConversationOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
func (s *GetFunctionNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetFunctionNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *GetFunctionOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetFunctionOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *GetFunctionOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetFunctionOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetFunctionOK) {
					name = jsonFieldsNameOfGetFunctionOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *GetFunctionTestRunTraceBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionTestRunTraceBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetFunctionTestRunTraceBadRequest(unwrapped)
	return nil
}
...
func (s *GetFunctionTestRunTraceForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionTestRunTraceForbidden to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetFunctionTestRunTraceForbidden(unwrapped)
	return nil
}
...
func (s *GetFunctionTestRunTraceNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionTestRunTraceNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetFunctionTestRunTraceNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *GetFunctionTestRunTraceOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetFunctionTestRunTraceOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *GetFunctionTestRunTraceOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionTestRunTraceOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetFunctionTestRunTraceOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetFunctionTestRunTraceOK) {
					name = jsonFieldsNameOfGetFunctionTestRunTraceOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *GetFunctionTestRunTraceUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionTestRunTraceUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetFunctionTestRunTraceUnauthorized(unwrapped)
	return nil
}
...
func (s *GetFunctionUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetFunctionUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetFunctionUnauthorized(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *GetInboxStatusOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetInboxStatusOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *GetInboxStatusOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetInboxStatusOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetInboxStatusOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetInboxStatusOK) {
					name = jsonFieldsNameOfGetInboxStatusOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *GetSendPermissionsOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetSendPermissionsOK = [3]string{
	0: "success",
	1: "data",
	2: "meta",
}
...
func (s *GetSendPermissionsOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetSendPermissionsOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "data":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.Data = make([]SendPermissionRule, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SendPermissionRule
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		return errors.Wrap(err, "decode GetSendPermissionsOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetSendPermissionsOK) {
					name = jsonFieldsNameOfGetSendPermissionsOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *GetSentEmailBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetSentEmailBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetSentEmailBadRequest(unwrapped)
	return nil
}
...
func (s *GetSentEmailNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetSentEmailNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetSentEmailNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *GetSentEmailOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetSentEmailOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *GetSentEmailOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetSentEmailOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetSentEmailOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetSentEmailOK) {
					name = jsonFieldsNameOfGetSentEmailOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *GetSentEmailUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetSentEmailUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetSentEmailUnauthorized(unwrapped)
	return nil
}
...
// Encode encodes GetThreadBadRequest as json.
func (s *GetThreadBadRequest) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes GetThreadBadRequest from json.
func (s *GetThreadBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetThreadBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetThreadBadRequest(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *GetThreadBadRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetThreadBadRequest) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes GetThreadNotFound as json.
func (s *GetThreadNotFound) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes GetThreadNotFound from json.
func (s *GetThreadNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetThreadNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetThreadNotFound(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *GetThreadNotFound) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetThreadNotFound) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *GetThreadOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *GetThreadOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfGetThreadOK = [2]string{
	0: "success",
	1: "data",
}

// Decode decodes GetThreadOK from json.
func (s *GetThreadOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetThreadOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode GetThreadOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfGetThreadOK) {
					name = jsonFieldsNameOfGetThreadOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *GetThreadOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetThreadOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes GetThreadUnauthorized as json.
func (s *GetThreadUnauthorized) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes GetThreadUnauthorized from json.
func (s *GetThreadUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode GetThreadUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = GetThreadUnauthorized(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *GetThreadUnauthorized) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *GetThreadUnauthorized) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// encodeFields encodes fields.
func (s *InboxStatus) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("ready")
		e.Bool(s.Ready)
	}
	{
		e.FieldStart("receiving_ready")
		e.Bool(s.ReceivingReady)
	}
	{
		e.FieldStart("processing_ready")
		e.Bool(s.ProcessingReady)
	}
	{
	...
	{
		e.FieldStart("next_actions")
		e.ArrStart()
		for _, elem := range s.NextActions {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
	...
	{
		e.FieldStart("recent_emails")
		s.RecentEmails.Encode(e)
	}
}

var jsonFieldsNameOfInboxStatus = [9]string{
	0: "ready",
	1: "receiving_ready",
	2: "processing_ready",
	3: "summary",
...
func (s *InboxStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatus to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "receiving_ready":
			...
			if err := func() error {
				v, err := d.Bool()
				s.ReceivingReady = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"receiving_ready\"")
			}
		case "processing_ready":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				v, err := d.Bool()
				s.ProcessingReady = bool(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"processing_ready\"")
			}
		case "summary":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
		...
		case "next_actions":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				s.NextActions = make([]InboxStatusNextAction, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem InboxStatusNextAction
					if err := elem.Decode(d); err != nil {
						return err
					}
				...
				return errors.Wrap(err, "decode field \"next_actions\"")
			}
		case "domains":
			requiredBitSet[0] |= 1 << 5
			if err := func() error {
				s.Domains = make([]InboxStatusDomain, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem InboxStatusDomain
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		case "recent_emails":
			requiredBitSet[1] |= 1 << 0
			if err := func() error {
				if err := s.RecentEmails.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"recent_emails\"")
			}
		default:
			return errors.Errorf("unexpected field %q", k)
		}
		...
		return errors.Wrap(err, "decode InboxStatus")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfInboxStatus) {
					name = jsonFieldsNameOfInboxStatus[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *InboxStatusDomain) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		e.Str(s.ID)
	}
	...
	{
		e.FieldStart("processing_route_count")
		e.Int(s.ProcessingRouteCount)
	}
	{
		e.FieldStart("endpoint_count")
		e.Int(s.EndpointCount)
	}
	{
		e.FieldStart("enabled_endpoint_count")
		e.Int(s.EnabledEndpointCount)
	}
	{
		e.FieldStart("function_endpoint_count")
		e.Int(s.FunctionEndpointCount)
	}
	{
		e.FieldStart("email_count")
		e.Int(s.EmailCount)
	}
	{
		e.FieldStart("latest_email_received_at")
		s.LatestEmailReceivedAt.Encode(e, json.EncodeDateTime)
	}
	{
		e.FieldStart("status")
		s.Status.Encode(e)
...
var jsonFieldsNameOfInboxStatusDomain = [14]string{
	0:  "id",
	1:  "domain",
	2:  "verified",
	3:  "active",
	...
	5:  "receiving_ready",
	6:  "processing_ready",
	7:  "processing_route_count",
	8:  "endpoint_count",
	9:  "enabled_endpoint_count",
	10: "function_endpoint_count",
	11: "email_count",
	12: "latest_email_received_at",
	13: "status",
}
...
func (s *InboxStatusDomain) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusDomain to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "processing_route_count":
			requiredBitSet[0] |= 1 << 7
			if err := func() error {
				v, err := d.Int()
				s.ProcessingRouteCount = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"processing_route_count\"")
			}
		case "endpoint_count":
			requiredBitSet[1] |= 1 << 0
			if err := func() error {
				v, err := d.Int()
				s.EndpointCount = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"endpoint_count\"")
			}
		case "enabled_endpoint_count":
			requiredBitSet[1] |= 1 << 1
			if err := func() error {
				v, err := d.Int()
				s.EnabledEndpointCount = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"enabled_endpoint_count\"")
			}
		case "function_endpoint_count":
			requiredBitSet[1] |= 1 << 2
			if err := func() error {
				v, err := d.Int()
				s.FunctionEndpointCount = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"function_endpoint_count\"")
			}
		case "email_count":
			requiredBitSet[1] |= 1 << 3
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"email_count\"")
			}
		case "latest_email_received_at":
			requiredBitSet[1] |= 1 << 4
			if err := func() error {
				if err := s.LatestEmailReceivedAt.Decode(d, json.DecodeDateTime); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"latest_email_received_at\"")
			}
		case "status":
			requiredBitSet[1] |= 1 << 5
			if err := func() error {
		...
		return errors.Wrap(err, "decode InboxStatusDomain")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfInboxStatusDomain) {
					name = jsonFieldsNameOfInboxStatusDomain[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *InboxStatusDomainStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusDomainStatus to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch InboxStatusDomainStatus(v) {
...
// encodeFields encodes fields.
func (s *InboxStatusEndpointSummary) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("total")
		e.Int(s.Total)
	}
	...
	}
	{
		...
		e.Int(s.FallbackEnabled)
	}
	{
		e.FieldStart("domain_scoped_enabled")
		e.Int(s.DomainScopedEnabled)
	}
	{
		e.FieldStart("http_enabled")
		e.Int(s.HTTPEnabled)
	}
	{
		e.FieldStart("function_enabled")
		e.Int(s.FunctionEnabled)
	}
}

var jsonFieldsNameOfInboxStatusEndpointSummary = [7]string{
	0: "total",
	1: "enabled",
	2: "disabled",
	3: "fallback_enabled",
	4: "domain_scoped_enabled",
	5: "http_enabled",
	6: "function_enabled",
}
...
func (s *InboxStatusEndpointSummary) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusEndpointSummary to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "domain_scoped_enabled":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				v, err := d.Int()
				s.DomainScopedEnabled = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"domain_scoped_enabled\"")
			}
		case "http_enabled":
			requiredBitSet[0] |= 1 << 5
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"http_enabled\"")
			}
		case "function_enabled":
			requiredBitSet[0] |= 1 << 6
			if err := func() error {
				v, err := d.Int()
				s.FunctionEnabled = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"function_enabled\"")
			}
		default:
			return errors.Errorf("unexpected field %q", k)
		}
		...
		return errors.Wrap(err, "decode InboxStatusEndpointSummary")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfInboxStatusEndpointSummary) {
					name = jsonFieldsNameOfInboxStatusEndpointSummary[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *InboxStatusFunctionSummary) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("total")
		e.Int(s.Total)
	}
...
var jsonFieldsNameOfInboxStatusFunctionSummary = [4]string{
	0: "total",
	1: "deployed",
	2: "pending",
	3: "failed",
...
func (s *InboxStatusFunctionSummary) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusFunctionSummary to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode InboxStatusFunctionSummary")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfInboxStatusFunctionSummary) {
					name = jsonFieldsNameOfInboxStatusFunctionSummary[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *InboxStatusNextAction) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("kind")
		s.Kind.Encode(e)
	}
...
var jsonFieldsNameOfInboxStatusNextAction = [3]string{
	0: "kind",
	1: "message",
	2: "command",
}
...
func (s *InboxStatusNextAction) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusNextAction to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode InboxStatusNextAction")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfInboxStatusNextAction) {
					name = jsonFieldsNameOfInboxStatusNextAction[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *InboxStatusNextActionKind) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusNextActionKind to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch InboxStatusNextActionKind(v) {
...
// encodeFields encodes fields.
func (s *InboxStatusRecentEmailSummary) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("total")
		e.Int(s.Total)
	}
	{
		e.FieldStart("latest_received_at")
		s.LatestReceivedAt.Encode(e, json.EncodeDateTime)
	}
}

var jsonFieldsNameOfInboxStatusRecentEmailSummary = [2]string{
	0: "total",
	1: "latest_received_at",
}

// Decode decodes InboxStatusRecentEmailSummary from json.
func (s *InboxStatusRecentEmailSummary) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode InboxStatusRecentEmailSummary to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "latest_received_at":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				if err := s.LatestReceivedAt.Decode(d, json.DecodeDateTime); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"latest_received_at\"")
			}
		default:
			return errors.Errorf("unexpected field %q", k)
		}
		...
		return errors.Wrap(err, "decode InboxStatusRecentEmailSummary")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfInboxStatusRecentEmailSummary) {
					name = jsonFieldsNameOfInboxStatusRecentEmailSummary[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *ListFunctionLogsBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionLogsBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListFunctionLogsBadRequest(unwrapped)
	return nil
}
...
func (s *ListFunctionLogsForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionLogsForbidden to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListFunctionLogsForbidden(unwrapped)
	return nil
}
...
func (s *ListFunctionLogsNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionLogsNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListFunctionLogsNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *ListFunctionLogsOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfListFunctionLogsOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *ListFunctionLogsOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionLogsOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ListFunctionLogsOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfListFunctionLogsOK) {
					name = jsonFieldsNameOfListFunctionLogsOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *ListFunctionLogsOKData) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("items")
		e.ArrStart()
...
var jsonFieldsNameOfListFunctionLogsOKData = [2]string{
	0: "items",
	1: "next_cursor",
}
...
func (s *ListFunctionLogsOKData) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionLogsOKData to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ListFunctionLogsOKData")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfListFunctionLogsOKData) {
					name = jsonFieldsNameOfListFunctionLogsOKData[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *ListFunctionLogsUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionLogsUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListFunctionLogsUnauthorized(unwrapped)
	return nil
}
...
func (s *ListFunctionSecretsNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionSecretsNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListFunctionSecretsNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *ListFunctionSecretsOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfListFunctionSecretsOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *ListFunctionSecretsOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionSecretsOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ListFunctionSecretsOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfListFunctionSecretsOK) {
					name = jsonFieldsNameOfListFunctionSecretsOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *ListFunctionSecretsOKData) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("items")
		e.ArrStart()
		for _, elem := range s.Items {
...
var jsonFieldsNameOfListFunctionSecretsOKData = [1]string{
	0: "items",
}
...
func (s *ListFunctionSecretsOKData) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionSecretsOKData to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "items":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				s.Items = make([]FunctionSecretListItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem FunctionSecretListItem
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Items = append(s.Items, elem)
		...
		return errors.Wrap(err, "decode ListFunctionSecretsOKData")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfListFunctionSecretsOKData) {
					name = jsonFieldsNameOfListFunctionSecretsOKData[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *ListFunctionSecretsUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionSecretsUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListFunctionSecretsUnauthorized(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *ListFunctionsOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfListFunctionsOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *ListFunctionsOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListFunctionsOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "data":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.Data = make([]FunctionListItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem FunctionListItem
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Data = append(s.Data, elem)
		...
		return errors.Wrap(err, "decode ListFunctionsOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfListFunctionsOK) {
					name = jsonFieldsNameOfListFunctionsOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *ListSentEmailsBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListSentEmailsBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListSentEmailsBadRequest(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *ListSentEmailsOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfListSentEmailsOK = [3]string{
	0: "success",
	1: "meta",
	2: "data",
}
...
func (s *ListSentEmailsOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListSentEmailsOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "data":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				s.Data = make([]SentEmailSummary, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SentEmailSummary
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Data = append(s.Data, elem)
		...
		return errors.Wrap(err, "decode ListSentEmailsOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfListSentEmailsOK) {
					name = jsonFieldsNameOfListSentEmailsOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *ListSentEmailsUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ListSentEmailsUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = ListSentEmailsUnauthorized(unwrapped)
	return nil
}
...
func (o *NilEmailWebhookStatus) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode NilEmailWebhookStatus to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
func (o *NilFunctionTestRunDeliveryEndpoint) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode NilFunctionTestRunDeliveryEndpoint to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
func (o *NilFunctionTestRunInboundEmail) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode NilFunctionTestRunInboundEmail to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
func (o *NilFunctionTestRunSend) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode NilFunctionTestRunSend to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
// Encode encodes SemanticSearchCoverage as json.
func (o NilSemanticSearchCoverage) Encode(e *jx.Encoder) {
	if o.Null {
		e.Null()
		return
	}
...
// Decode decodes SemanticSearchCoverage from json.
func (o *NilSemanticSearchCoverage) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode NilSemanticSearchCoverage to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s NilSemanticSearchCoverage) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (o *OptCliLogoutInput) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptCliLogoutInput to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
func (o *OptEmailSearchFacets) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptEmailSearchFacets to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
func (o *OptEmailSearchHighlights) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptEmailSearchHighlights to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
func (o *OptEmailStatus) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptEmailStatus to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
func (o OptNilEmailAddressArray) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	if o.Null {
...
// Decode decodes []EmailAddress from json.
func (o *OptNilEmailAddressArray) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptNilEmailAddressArray to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
	...
	o.Set = true
	o.Null = false
	o.Value = make([]EmailAddress, 0)
	if err := d.Arr(func(d *jx.Decoder) error {
		var elem EmailAddress
		if err := elem.Decode(d); err != nil {
			return err
		}
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptNilEmailAddressArray) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (o *OptNilFunctionLogRowMetadata) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptNilFunctionLogRowMetadata to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
	...
	o.Set = true
	o.Null = false
	o.Value = make(FunctionLogRowMetadata)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
func (o *OptNilGateDenialArray) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptNilGateDenialArray to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
// Decode decodes ParsedEmailDataError from json.
func (o *OptNilParsedEmailDataError) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptNilParsedEmailDataError to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptNilParsedEmailDataError) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// Decode decodes SemanticSearchInputMode from json.
func (o *OptSemanticSearchInputMode) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptSemanticSearchInputMode to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptSemanticSearchInputMode) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptSemanticSearchInputMode) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
func (o *OptSentEmailStatus) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptSentEmailStatus to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
func (o *OptStartAgentSignupInputMetadata) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptStartAgentSignupInputMetadata to nil")
	}
	o.Set = true
	o.Value = make(StartAgentSignupInputMetadata)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
func (o *OptStartCliLoginInput) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptStartCliLoginInput to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
func (o *OptStartCliLoginInputMetadata) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptStartCliLoginInputMetadata to nil")
	}
	o.Set = true
	o.Value = make(StartCliLoginInputMetadata)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
func (o *OptStartCliSignupInputMetadata) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptStartCliSignupInputMetadata to nil")
	}
	o.Set = true
	o.Value = make(StartCliSignupInputMetadata)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
func (o *OptTestFunctionReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptTestFunctionReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// Encode implements json.Marshaler.
func (s *ParsedEmailData) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ParsedEmailData) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("status")
		s.Status.Encode(e)
	}
...
var jsonFieldsNameOfParsedEmailData = [11]string{
	0:  "status",
	1:  "body_text",
	2:  "body_html",
	3:  "reply_to",
...
// Decode decodes ParsedEmailData from json.
func (s *ParsedEmailData) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ParsedEmailData to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "attachments":
			if err := func() error {
				s.Attachments = make([]EmailAttachment, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem EmailAttachment
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		return errors.Wrap(err, "decode ParsedEmailData")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfParsedEmailData) {
					name = jsonFieldsNameOfParsedEmailData[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ParsedEmailData) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ParsedEmailData) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *ParsedEmailDataError) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
var jsonFieldsNameOfParsedEmailDataError = [3]string{
	0: "code",
	1: "message",
	2: "retryable",
}
...
// Decode decodes ParsedEmailDataError from json.
func (s *ParsedEmailDataError) Decode(d *jx.Decoder) error {
	if s == nil {
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ParsedEmailDataError) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ParsedEmailDataError) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes ParsedEmailDataStatus as json.
func (s ParsedEmailDataStatus) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ParsedEmailDataStatus from json.
func (s *ParsedEmailDataStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ParsedEmailDataStatus to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch ParsedEmailDataStatus(v) {
...
// MarshalJSON implements stdjson.Marshaler.
func (s ParsedEmailDataStatus) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ParsedEmailDataStatus) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// encodeFields encodes fields.
func (s *PollCliLoginInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("device_code")
		e.Str(s.DeviceCode)
	}
...
var jsonFieldsNameOfPollCliLoginInput = [1]string{
	0: "device_code",
}
...
func (s *PollCliLoginInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PollCliLoginInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PollCliLoginInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPollCliLoginInput) {
					name = jsonFieldsNameOfPollCliLoginInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *PollCliLoginOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfPollCliLoginOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *PollCliLoginOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PollCliLoginOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PollCliLoginOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPollCliLoginOK) {
					name = jsonFieldsNameOfPollCliLoginOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *ResendAgentSignupVerificationInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("signup_token")
		e.Str(s.SignupToken)
	}
...
var jsonFieldsNameOfResendAgentSignupVerificationInput = [1]string{
	0: "signup_token",
}
...
func (s *ResendAgentSignupVerificationInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ResendAgentSignupVerificationInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ResendAgentSignupVerificationInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfResendAgentSignupVerificationInput) {
					name = jsonFieldsNameOfResendAgentSignupVerificationInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *ResendAgentSignupVerificationOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfResendAgentSignupVerificationOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *ResendAgentSignupVerificationOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ResendAgentSignupVerificationOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ResendAgentSignupVerificationOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfResendAgentSignupVerificationOK) {
					name = jsonFieldsNameOfResendAgentSignupVerificationOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *ResendCliSignupVerificationInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("signup_token")
		e.Str(s.SignupToken)
	}
...
var jsonFieldsNameOfResendCliSignupVerificationInput = [1]string{
	0: "signup_token",
}
...
func (s *ResendCliSignupVerificationInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ResendCliSignupVerificationInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ResendCliSignupVerificationInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfResendCliSignupVerificationInput) {
					name = jsonFieldsNameOfResendCliSignupVerificationInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *ResendCliSignupVerificationOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfResendCliSignupVerificationOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *ResendCliSignupVerificationOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ResendCliSignupVerificationOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ResendCliSignupVerificationOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfResendCliSignupVerificationOK) {
					name = jsonFieldsNameOfResendCliSignupVerificationOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SearchEmailsBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SearchEmailsBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SearchEmailsBadRequest(unwrapped)
	return nil
}
...
func (s *SearchEmailsGatewayTimeout) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SearchEmailsGatewayTimeout to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SearchEmailsGatewayTimeout(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *SearchEmailsOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfSearchEmailsOK = [4]string{
	0: "success",
	1: "data",
	2: "meta",
	3: "facets",
...
func (s *SearchEmailsOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SearchEmailsOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "data":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.Data = make([]EmailSearchResult, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem EmailSearchResult
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Data = append(s.Data, elem)
		...
		return errors.Wrap(err, "decode SearchEmailsOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSearchEmailsOK) {
					name = jsonFieldsNameOfSearchEmailsOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SearchEmailsUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SearchEmailsUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SearchEmailsUnauthorized(unwrapped)
	return nil
}
...
// Encode encodes SemanticSearchBadRequest as json.
func (s *SemanticSearchBadRequest) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes SemanticSearchBadRequest from json.
func (s *SemanticSearchBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SemanticSearchBadRequest(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchBadRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchBadRequest) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchCoverage) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchCoverage) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("embedded_chunks")
		e.Int(s.EmbeddedChunks)
	}
	{
		e.FieldStart("pending_chunks")
		e.Int(s.PendingChunks)
	}
	{
		e.FieldStart("skipped_plan_chunks")
		e.Int(s.SkippedPlanChunks)
	}
	{
		e.FieldStart("skipped_quota_chunks")
		e.Int(s.SkippedQuotaChunks)
	}
	{
		e.FieldStart("unsupported_attachment_chunks")
		e.Int(s.UnsupportedAttachmentChunks)
	}
	{
		e.FieldStart("failed_chunks")
		e.Int(s.FailedChunks)
	}
}

var jsonFieldsNameOfSemanticSearchCoverage = [6]string{
	0: "embedded_chunks",
	1: "pending_chunks",
	2: "skipped_plan_chunks",
	3: "skipped_quota_chunks",
	4: "unsupported_attachment_chunks",
	5: "failed_chunks",
}

// Decode decodes SemanticSearchCoverage from json.
func (s *SemanticSearchCoverage) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchCoverage to nil")
	}
	var requiredBitSet [1]uint8

	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		switch string(k) {
		case "embedded_chunks":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				v, err := d.Int()
				s.EmbeddedChunks = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"embedded_chunks\"")
			}
		case "pending_chunks":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				v, err := d.Int()
				s.PendingChunks = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"pending_chunks\"")
			}
		case "skipped_plan_chunks":
			requiredBitSet[0] |= 1 << 2
			if err := func() error {
				v, err := d.Int()
				s.SkippedPlanChunks = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"skipped_plan_chunks\"")
			}
		case "skipped_quota_chunks":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				v, err := d.Int()
				s.SkippedQuotaChunks = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"skipped_quota_chunks\"")
			}
		case "unsupported_attachment_chunks":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
				v, err := d.Int()
				s.UnsupportedAttachmentChunks = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"unsupported_attachment_chunks\"")
			}
		case "failed_chunks":
			requiredBitSet[0] |= 1 << 5
			if err := func() error {
				v, err := d.Int()
				s.FailedChunks = int(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"failed_chunks\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode SemanticSearchCoverage")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSemanticSearchCoverage) {
					name = jsonFieldsNameOfSemanticSearchCoverage[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchCoverage) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchCoverage) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchField as json.
func (s SemanticSearchField) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SemanticSearchField from json.
func (s *SemanticSearchField) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchField to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s SemanticSearchField) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchField) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchForbidden as json.
func (s *SemanticSearchForbidden) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes SemanticSearchForbidden from json.
func (s *SemanticSearchForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchForbidden to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SemanticSearchForbidden(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchForbidden) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchForbidden) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchInput) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchInput) encodeFields(e *jx.Encoder) {
	{
		if s.Query.Set {
			e.FieldStart("query")
			s.Query.Encode(e)
	...
	{
		if s.SearchIn != nil {
			e.FieldStart("search_in")
			e.ArrStart()
			for _, elem := range s.SearchIn {
				elem.Encode(e)
			}
			e.ArrEnd()
		}
	...
	}
	{
		if s.DateFrom.Set {
			...
			s.DateFrom.Encode(e, json.EncodeDateTime)
		}
	}
	{
		if s.DateTo.Set {
			e.FieldStart("date_to")
			s.DateTo.Encode(e, json.EncodeDateTime)
		}
	}
	{
		if s.Include != nil {
...
var jsonFieldsNameOfSemanticSearchInput = [10]string{
	0: "query",
	1: "mode",
	2: "corpus",
	3: "search_in",
...
// Decode decodes SemanticSearchInput from json.
func (s *SemanticSearchInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchInput to nil")
	}
	s.setDefaults()
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "corpus":
			if err := func() error {
				s.Corpus = make([]SemanticSearchInputCorpusItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchInputCorpusItem
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Corpus = append(s.Corpus, elem)
					return nil
				}); err != nil {
					return err
				}
		...
		case "search_in":
			if err := func() error {
				s.SearchIn = make([]SemanticSearchField, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchField
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.SearchIn = append(s.SearchIn, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"search_in\"")
			}
		case "exclude":
			if err := func() error {
				s.Exclude = make([]SemanticSearchField, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchField
					if err := elem.Decode(d); err != nil {
						return err
		...
		case "date_from":
			if err := func() error {
				s.DateFrom.Reset()
				if err := s.DateFrom.Decode(d, json.DecodeDateTime); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		case "date_to":
			if err := func() error {
				s.DateTo.Reset()
				if err := s.DateTo.Decode(d, json.DecodeDateTime); err != nil {
					return err
				}
				return nil
			}(); err != nil {
		...
		case "include":
			if err := func() error {
				s.Include = make([]SemanticSearchInputIncludeItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchInputIncludeItem
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		return errors.Wrap(err, "decode SemanticSearchInput")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchInput) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchInput) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchInputCorpusItem as json.
func (s SemanticSearchInputCorpusItem) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SemanticSearchInputCorpusItem from json.
func (s *SemanticSearchInputCorpusItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchInputCorpusItem to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch SemanticSearchInputCorpusItem(v) {
	...
	default:
		*s = SemanticSearchInputCorpusItem(v)
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s SemanticSearchInputCorpusItem) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchInputCorpusItem) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchInputIncludeItem as json.
func (s SemanticSearchInputIncludeItem) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SemanticSearchInputIncludeItem from json.
func (s *SemanticSearchInputIncludeItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchInputIncludeItem to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s SemanticSearchInputIncludeItem) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchInputIncludeItem) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchInputMode as json.
func (s SemanticSearchInputMode) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SemanticSearchInputMode from json.
func (s *SemanticSearchInputMode) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchInputMode to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch SemanticSearchInputMode(v) {
...
// MarshalJSON implements stdjson.Marshaler.
func (s SemanticSearchInputMode) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchInputMode) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchInternalServerError as json.
func (s *SemanticSearchInternalServerError) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes SemanticSearchInternalServerError from json.
func (s *SemanticSearchInternalServerError) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchInternalServerError to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SemanticSearchInternalServerError(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchInternalServerError) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchInternalServerError) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchMeta) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchMeta) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("limit")
		e.Int(s.Limit)
	}
...
var jsonFieldsNameOfSemanticSearchMeta = [4]string{
	0: "limit",
	1: "cursor",
	2: "mode",
	3: "coverage",
...
// Decode decodes SemanticSearchMeta from json.
func (s *SemanticSearchMeta) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchMeta to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SemanticSearchMeta")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSemanticSearchMeta) {
					name = jsonFieldsNameOfSemanticSearchMeta[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchMeta) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchMeta) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchMetaMode as json.
func (s SemanticSearchMetaMode) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SemanticSearchMetaMode from json.
func (s *SemanticSearchMetaMode) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchMetaMode to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch SemanticSearchMetaMode(v) {
...
// MarshalJSON implements stdjson.Marshaler.
func (s SemanticSearchMetaMode) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchMetaMode) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfSemanticSearchOK = [3]string{
	0: "success",
	1: "data",
	2: "meta",
}

// Decode decodes SemanticSearchOK from json.
func (s *SemanticSearchOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "data":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.Data = make([]SemanticSearchResult, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchResult
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Data = append(s.Data, elem)
		...
		return errors.Wrap(err, "decode SemanticSearchOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSemanticSearchOK) {
					name = jsonFieldsNameOfSemanticSearchOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchResult) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchResult) encodeFields(e *jx.Encoder) {
	{
	...
	{
		e.FieldStart("semantic_score")
		s.SemanticScore.Encode(e)
	}
	{
		e.FieldStart("keyword_score")
		s.KeywordScore.Encode(e)
	}
	{
		e.FieldStart("matched_fields")
		e.ArrStart()
		for _, elem := range s.MatchedFields {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
	...
	{
		e.FieldStart("score_breakdown")
		s.ScoreBreakdown.Encode(e)
	}
	{
...
var jsonFieldsNameOfSemanticSearchResult = [14]string{
	0:  "source_type",
	1:  "id",
	2:  "subject",
	3:  "from",
...
// Decode decodes SemanticSearchResult from json.
func (s *SemanticSearchResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchResult to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "semantic_score":
			requiredBitSet[1] |= 1 << 0
			if err := func() error {
				if err := s.SemanticScore.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"semantic_score\"")
			}
		case "keyword_score":
			requiredBitSet[1] |= 1 << 1
			if err := func() error {
				if err := s.KeywordScore.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"keyword_score\"")
			}
		case "matched_fields":
			requiredBitSet[1] |= 1 << 2
			if err := func() error {
				s.MatchedFields = make([]SemanticSearchField, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchField
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.MatchedFields = append(s.MatchedFields, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"matched_fields\"")
			}
		case "snippets":
			requiredBitSet[1] |= 1 << 3
			if err := func() error {
				s.Snippets = make([]SemanticSearchSnippet, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SemanticSearchSnippet
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		case "score_breakdown":
			requiredBitSet[1] |= 1 << 4
			if err := func() error {
				if err := s.ScoreBreakdown.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"score_breakdown\"")
			}
		case "api_url":
			requiredBitSet[1] |= 1 << 5
			if err := func() error {
		...
		return errors.Wrap(err, "decode SemanticSearchResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSemanticSearchResult) {
					name = jsonFieldsNameOfSemanticSearchResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchResult) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchResult) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchResultSourceType as json.
func (s SemanticSearchResultSourceType) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SemanticSearchResultSourceType from json.
func (s *SemanticSearchResultSourceType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchResultSourceType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch SemanticSearchResultSourceType(v) {
	...
	default:
		*s = SemanticSearchResultSourceType(v)
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s SemanticSearchResultSourceType) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchResultSourceType) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchScoreBreakdown) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchScoreBreakdown) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("semantic")
		s.Semantic.Encode(e)
	}
	{
	...
	{
		e.FieldStart("field_boost")
		e.Float64(s.FieldBoost)
	}
	{
		e.FieldStart("recency")
		e.Float64(s.Recency)
	}
}

var jsonFieldsNameOfSemanticSearchScoreBreakdown = [4]string{
	0: "semantic",
	1: "keyword",
	2: "field_boost",
	3: "recency",
...
// Decode decodes SemanticSearchScoreBreakdown from json.
func (s *SemanticSearchScoreBreakdown) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchScoreBreakdown to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "semantic":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				if err := s.Semantic.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"semantic\"")
			}
		case "keyword":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
		...
		case "field_boost":
			...
			if err := func() error {
				v, err := d.Float64()
				s.FieldBoost = float64(v)
				if err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"field_boost\"")
			}
		case "recency":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"recency\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode SemanticSearchScoreBreakdown")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSemanticSearchScoreBreakdown) {
					name = jsonFieldsNameOfSemanticSearchScoreBreakdown[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchScoreBreakdown) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchScoreBreakdown) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchServiceUnavailable as json.
func (s *SemanticSearchServiceUnavailable) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes SemanticSearchServiceUnavailable from json.
func (s *SemanticSearchServiceUnavailable) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchServiceUnavailable to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SemanticSearchServiceUnavailable(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchServiceUnavailable) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchServiceUnavailable) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SemanticSearchSnippet) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SemanticSearchSnippet) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("field")
		e.Str(s.Field)
	}
...
var jsonFieldsNameOfSemanticSearchSnippet = [2]string{
	0: "field",
	1: "text",
}

// Decode decodes SemanticSearchSnippet from json.
func (s *SemanticSearchSnippet) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchSnippet to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SemanticSearchSnippet")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSemanticSearchSnippet) {
					name = jsonFieldsNameOfSemanticSearchSnippet[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchSnippet) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchSnippet) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SemanticSearchUnauthorized as json.
func (s *SemanticSearchUnauthorized) Encode(e *jx.Encoder) {
	unwrapped := (*ErrorResponse)(s)

	unwrapped.Encode(e)
}

// Decode decodes SemanticSearchUnauthorized from json.
func (s *SemanticSearchUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SemanticSearchUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SemanticSearchUnauthorized(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *SemanticSearchUnauthorized) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SemanticSearchUnauthorized) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// encodeFields encodes fields.
func (s *SendPermissionAddress) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("type")
		s.Type.Encode(e)
	}
...
var jsonFieldsNameOfSendPermissionAddress = [5]string{
	0: "type",
	1: "address",
	2: "last_received_at",
	3: "received_count",
...
func (s *SendPermissionAddress) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionAddress to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "last_received_at":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"last_received_at\"")
			}
		case "received_count":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				v, err := d.Int()
				s.ReceivedCount = int(v)
				if err != nil {
					return err
				}
				return nil
		...
		return errors.Wrap(err, "decode SendPermissionAddress")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSendPermissionAddress) {
					name = jsonFieldsNameOfSendPermissionAddress[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SendPermissionAddressType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionAddressType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *SendPermissionAnyRecipient) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("type")
		s.Type.Encode(e)
	}
...
var jsonFieldsNameOfSendPermissionAnyRecipient = [2]string{
	0: "type",
	1: "description",
}
...
func (s *SendPermissionAnyRecipient) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionAnyRecipient to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SendPermissionAnyRecipient")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSendPermissionAnyRecipient) {
					name = jsonFieldsNameOfSendPermissionAnyRecipient[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SendPermissionAnyRecipientType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionAnyRecipientType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *SendPermissionManagedZone) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("type")
		s.Type.Encode(e)
	}
...
var jsonFieldsNameOfSendPermissionManagedZone = [3]string{
	0: "type",
	1: "zone",
	2: "description",
}
...
func (s *SendPermissionManagedZone) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionManagedZone to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SendPermissionManagedZone")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSendPermissionManagedZone) {
					name = jsonFieldsNameOfSendPermissionManagedZone[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SendPermissionManagedZoneType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionManagedZoneType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
func (s *SendPermissionRule) Decode(d *jx.Decoder) error {
	...
	switch s.Type {
	case SendPermissionAnyRecipientSendPermissionRule:
		if err := s.SendPermissionAnyRecipient.Decode(d); err != nil {
			return err
		}
	case SendPermissionManagedZoneSendPermissionRule:
		if err := s.SendPermissionManagedZone.Decode(d); err != nil {
			return err
		}
	case SendPermissionYourDomainSendPermissionRule:
		if err := s.SendPermissionYourDomain.Decode(d); err != nil {
			return err
		}
	case SendPermissionAddressSendPermissionRule:
		if err := s.SendPermissionAddress.Decode(d); err != nil {
			return err
		}
	default:
		return errors.Errorf("inferred invalid type: %s", s.Type)
...
// encodeFields encodes fields.
func (s *SendPermissionYourDomain) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("type")
		s.Type.Encode(e)
	}
...
var jsonFieldsNameOfSendPermissionYourDomain = [3]string{
	0: "type",
	1: "domain",
	2: "description",
}
...
func (s *SendPermissionYourDomain) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionYourDomain to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SendPermissionYourDomain")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSendPermissionYourDomain) {
					name = jsonFieldsNameOfSendPermissionYourDomain[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SendPermissionYourDomainType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionYourDomainType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// encodeFields encodes fields.
func (s *SendPermissionsMeta) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("address_cap")
		e.Int(s.AddressCap)
	}
	{
		e.FieldStart("truncated")
...
var jsonFieldsNameOfSendPermissionsMeta = [2]string{
	0: "address_cap",
	1: "truncated",
}
...
func (s *SendPermissionsMeta) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SendPermissionsMeta to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "address_cap":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"address_cap\"")
			}
		case "truncated":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
		...
		return errors.Wrap(err, "decode SendPermissionsMeta")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSendPermissionsMeta) {
					name = jsonFieldsNameOfSendPermissionsMeta[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *SentEmailDetail) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
	...
	{
		e.FieldStart("body_size_bytes")
		e.Int(s.BodySizeBytes)
	}
	{
		if s.ContentDiscardedAt.Set {
			e.FieldStart("content_discarded_at")
	...
	{
		if s.EmailReferences.Set {
			e.FieldStart("email_references")
			s.EmailReferences.Encode(e)
		}
	}
	{
		if s.InReplyToEmailID.Set {
			e.FieldStart("in_reply_to_email_id")
			s.InReplyToEmailID.Encode(e)
		}
	}
	{
		if s.ThreadID.Set {
	...
	{
		if s.SMTPEnhancedStatusCode.Set {
			e.FieldStart("smtp_enhanced_status_code")
			s.SMTPEnhancedStatusCode.Encode(e)
		}
	}
	{
		if s.DkimSelector.Set {
			e.FieldStart("dkim_selector")
			s.DkimSelector.Encode(e)
		}
	}
	{
		if s.DkimDomain.Set {
			e.FieldStart("dkim_domain")
			s.DkimDomain.Encode(e)
		}
	}
	{
		if s.ErrorCode.Set {
...
var jsonFieldsNameOfSentEmailDetail = [31]string{
	0:  "id",
	1:  "status",
	2:  "status_changed_at",
	3:  "created_at",
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "to_header":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"to_header\"")
			}
		case "to_address":
			requiredBitSet[1] |= 1 << 2
			if err := func() error {
		...
		case "body_size_bytes":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"body_size_bytes\"")
			}
		case "content_discarded_at":
			if err := func() error {
				s.ContentDiscardedAt.Reset()
		...
		case "email_references":
			if err := func() error {
				s.EmailReferences.Reset()
				if err := s.EmailReferences.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"email_references\"")
			}
		case "in_reply_to_email_id":
			if err := func() error {
				s.InReplyToEmailID.Reset()
				if err := s.InReplyToEmailID.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"in_reply_to_email_id\"")
			}
		case "thread_id":
			if err := func() error {
				s.ThreadID.Reset()
		...
		case "smtp_enhanced_status_code":
			if err := func() error {
				s.SMTPEnhancedStatusCode.Reset()
				if err := s.SMTPEnhancedStatusCode.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"smtp_enhanced_status_code\"")
			}
		case "dkim_selector":
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"dkim_selector\"")
			}
		case "dkim_domain":
			if err := func() error {
				s.DkimDomain.Reset()
				if err := s.DkimDomain.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"dkim_domain\"")
			}
		case "error_code":
			if err := func() error {
				s.ErrorCode.Reset()
		...
		return errors.Wrap(err, "decode SentEmailDetail")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [4]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSentEmailDetail) {
					name = jsonFieldsNameOfSentEmailDetail[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *SentEmailSummary) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		json.EncodeUUID(e, s.ID)
	}
...
var jsonFieldsNameOfSentEmailSummary = [29]string{
	0:  "id",
	1:  "status",
	2:  "status_changed_at",
	3:  "created_at",
...
func (s *SentEmailSummary) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SentEmailSummary")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [4]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSentEmailSummary) {
					name = jsonFieldsNameOfSentEmailSummary[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SetFunctionSecretBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SetFunctionSecretBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SetFunctionSecretBadRequest(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *SetFunctionSecretCreated) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfSetFunctionSecretCreated = [2]string{
	0: "success",
	1: "data",
}
...
func (s *SetFunctionSecretCreated) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SetFunctionSecretCreated to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SetFunctionSecretCreated")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSetFunctionSecretCreated) {
					name = jsonFieldsNameOfSetFunctionSecretCreated[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *SetFunctionSecretInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("value")
		e.Str(s.Value)
	}
...
var jsonFieldsNameOfSetFunctionSecretInput = [1]string{
	0: "value",
}
...
func (s *SetFunctionSecretInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SetFunctionSecretInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SetFunctionSecretInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSetFunctionSecretInput) {
					name = jsonFieldsNameOfSetFunctionSecretInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SetFunctionSecretNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SetFunctionSecretNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SetFunctionSecretNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *SetFunctionSecretOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfSetFunctionSecretOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *SetFunctionSecretOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SetFunctionSecretOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SetFunctionSecretOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSetFunctionSecretOK) {
					name = jsonFieldsNameOfSetFunctionSecretOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *SetFunctionSecretUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SetFunctionSecretUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = SetFunctionSecretUnauthorized(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *StartAgentSignupCreated) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfStartAgentSignupCreated = [2]string{
	0: "success",
	1: "data",
}
...
func (s *StartAgentSignupCreated) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartAgentSignupCreated to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode StartAgentSignupCreated")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfStartAgentSignupCreated) {
					name = jsonFieldsNameOfStartAgentSignupCreated[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *StartAgentSignupInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("email")
		e.Str(s.Email)
	}
...
func (s *StartAgentSignupInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartAgentSignupInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "terms_accepted":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"terms_accepted\"")
			}
		case "device_name":
			if err := func() error {
				s.DeviceName.Reset()
		...
		return errors.Wrap(err, "decode StartAgentSignupInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfStartAgentSignupInput) {
					name = jsonFieldsNameOfStartAgentSignupInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields implements json.Marshaler.
func (s StartAgentSignupInputMetadata) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
func (s *StartAgentSignupInputMetadata) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartAgentSignupInputMetadata to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem jx.Raw
		...
		return errors.Wrap(err, "decode StartAgentSignupInputMetadata")
	}
...
// encodeFields encodes fields.
func (s *StartCliLoginCreated) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfStartCliLoginCreated = [2]string{
	0: "success",
	1: "data",
}
...
func (s *StartCliLoginCreated) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartCliLoginCreated to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode StartCliLoginCreated")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfStartCliLoginCreated) {
					name = jsonFieldsNameOfStartCliLoginCreated[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *StartCliLoginInput) encodeFields(e *jx.Encoder) {
	{
		if s.DeviceName.Set {
			e.FieldStart("device_name")
			s.DeviceName.Encode(e)
...
var jsonFieldsNameOfStartCliLoginInput = [2]string{
	0: "device_name",
	1: "metadata",
}
...
func (s *StartCliLoginInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartCliLoginInput to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode StartCliLoginInput")
	}
...
// encodeFields implements json.Marshaler.
func (s StartCliLoginInputMetadata) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
func (s *StartCliLoginInputMetadata) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartCliLoginInputMetadata to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem jx.Raw
		...
		return errors.Wrap(err, "decode StartCliLoginInputMetadata")
	}
...
// encodeFields encodes fields.
func (s *StartCliSignupCreated) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfStartCliSignupCreated = [2]string{
	0: "success",
	1: "data",
}
...
func (s *StartCliSignupCreated) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartCliSignupCreated to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode StartCliSignupCreated")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfStartCliSignupCreated) {
					name = jsonFieldsNameOfStartCliSignupCreated[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *StartCliSignupInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("email")
		e.Str(s.Email)
	}
...
func (s *StartCliSignupInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartCliSignupInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode StartCliSignupInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfStartCliSignupInput) {
					name = jsonFieldsNameOfStartCliSignupInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields implements json.Marshaler.
func (s StartCliSignupInputMetadata) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
func (s *StartCliSignupInputMetadata) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode StartCliSignupInputMetadata to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem jx.Raw
		...
		return errors.Wrap(err, "decode StartCliSignupInputMetadata")
	}
...
func (s *TestFunctionBadGateway) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionBadGateway to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = TestFunctionBadGateway(unwrapped)
	return nil
}
...
func (s *TestFunctionBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = TestFunctionBadRequest(unwrapped)
	return nil
}
...
func (s *TestFunctionNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = TestFunctionNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *TestFunctionOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfTestFunctionOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *TestFunctionOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode TestFunctionOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfTestFunctionOK) {
					name = jsonFieldsNameOfTestFunctionOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *TestFunctionReq) encodeFields(e *jx.Encoder) {
	{
		if s.LocalPart.Set {
			e.FieldStart("local_part")
			s.LocalPart.Encode(e)
		}
	}
}

var jsonFieldsNameOfTestFunctionReq = [1]string{
	0: "local_part",
}
...
func (s *TestFunctionReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionReq to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "local_part":
			if err := func() error {
				s.LocalPart.Reset()
				if err := s.LocalPart.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"local_part\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode TestFunctionReq")
	}
...
func (s *TestFunctionServiceUnavailable) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionServiceUnavailable to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = TestFunctionServiceUnavailable(unwrapped)
	return nil
}
...
func (s *TestFunctionUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = TestFunctionUnauthorized(unwrapped)
	return nil
}
...
func (s *TestFunctionUnprocessableEntity) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestFunctionUnprocessableEntity to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = TestFunctionUnprocessableEntity(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *TestInvocationResult) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("test_run_id")
		json.EncodeUUID(e, s.TestRunID)
	}
	{
		e.FieldStart("inbound_domain")
		e.Str(s.InboundDomain)
	...
	{
		e.FieldStart("watch_url")
		json.EncodeURI(e, s.WatchURL)
	}
	{
		e.FieldStart("trace_url")
		e.Str(s.TraceURL)
	}
}

var jsonFieldsNameOfTestInvocationResult = [9]string{
	0: "test_run_id",
	1: "inbound_domain",
	2: "to",
	3: "from",
...
func (s *TestInvocationResult) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode TestInvocationResult to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "send_id":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"send_id\"")
			}
		case "subject":
			requiredBitSet[0] |= 1 << 5
			if err := func() error {
		...
		case "watch_url":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"watch_url\"")
			}
		case "trace_url":
			requiredBitSet[1] |= 1 << 0
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"trace_url\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode TestInvocationResult")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfTestInvocationResult) {
					name = jsonFieldsNameOfTestInvocationResult[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *Thread) encodeFields(e *jx.Encoder) {
	...
	{
		if s.FirstMessageAt.Set {
			e.FieldStart("first_message_at")
			s.FirstMessageAt.Encode(e, json.EncodeDateTime)
		}
	}
	{
...
var jsonFieldsNameOfThread = [8]string{
	0: "id",
	1: "subject",
	2: "root_message_id",
	3: "message_count",
...
func (s *Thread) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "first_message_at":
			if err := func() error {
				s.FirstMessageAt.Reset()
				if err := s.FirstMessageAt.Decode(d, json.DecodeDateTime); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"first_message_at\"")
			}
...
// Encode encodes ThreadMessageDirection as json.
func (s ThreadMessageDirection) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ThreadMessageDirection from json.
func (s *ThreadMessageDirection) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ThreadMessageDirection to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch ThreadMessageDirection(v) {
...
// MarshalJSON implements stdjson.Marshaler.
func (s ThreadMessageDirection) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (s *UpdateFunctionBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdateFunctionBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = UpdateFunctionBadRequest(unwrapped)
	return nil
}
...
func (s *UpdateFunctionNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdateFunctionNotFound to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = UpdateFunctionNotFound(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *UpdateFunctionOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfUpdateFunctionOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *UpdateFunctionOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdateFunctionOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode UpdateFunctionOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfUpdateFunctionOK) {
					name = jsonFieldsNameOfUpdateFunctionOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *UpdateFunctionUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdateFunctionUnauthorized to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = UpdateFunctionUnauthorized(unwrapped)
	return nil
}
...
func (s *VerifyAgentSignupBadRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyAgentSignupBadRequest to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = VerifyAgentSignupBadRequest(unwrapped)
	return nil
}
...
func (s *VerifyAgentSignupConflict) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyAgentSignupConflict to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = VerifyAgentSignupConflict(unwrapped)
	return nil
}
...
func (s *VerifyAgentSignupForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyAgentSignupForbidden to nil")
	}
	var unwrapped ErrorResponse
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = VerifyAgentSignupForbidden(unwrapped)
	return nil
}
...
// encodeFields encodes fields.
func (s *VerifyAgentSignupInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("signup_token")
		e.Str(s.SignupToken)
	}
...
var jsonFieldsNameOfVerifyAgentSignupInput = [3]string{
	0: "signup_token",
	1: "verification_code",
	2: "org_id",
}
...
func (s *VerifyAgentSignupInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyAgentSignupInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode VerifyAgentSignupInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfVerifyAgentSignupInput) {
					name = jsonFieldsNameOfVerifyAgentSignupInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *VerifyAgentSignupOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfVerifyAgentSignupOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *VerifyAgentSignupOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyAgentSignupOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode VerifyAgentSignupOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfVerifyAgentSignupOK) {
					name = jsonFieldsNameOfVerifyAgentSignupOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *VerifyCliSignupInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("signup_token")
		e.Str(s.SignupToken)
	}
...
var jsonFieldsNameOfVerifyCliSignupInput = [3]string{
	0: "signup_token",
	1: "verification_code",
	2: "password",
}
...
func (s *VerifyCliSignupInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyCliSignupInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode VerifyCliSignupInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfVerifyCliSignupInput) {
					name = jsonFieldsNameOfVerifyCliSignupInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// encodeFields encodes fields.
func (s *VerifyCliSignupOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("success")
		e.Bool(true)
	}
...
var jsonFieldsNameOfVerifyCliSignupOK = [2]string{
	0: "success",
	1: "data",
}
...
func (s *VerifyCliSignupOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode VerifyCliSignupOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode VerifyCliSignupOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfVerifyCliSignupOK) {
					name = jsonFieldsNameOfVerifyCliSignupOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
