...
func unpackCompleteWebhookEventParams(packed middleware.Parameters) (params CompleteWebhookEventParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeCompleteWebhookEventParams(args [1]string, argsEscaped bool, r *http.Request) (params CompleteWebhookEventParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
...
// DownloadEmailAttachmentPartParams is parameters of downloadEmailAttachmentPart operation.
...
func unpackDownloadEmailAttachmentPartParams(packed middleware.Parameters) (params DownloadEmailAttachmentPartParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
	...
	}
	{
		...
		params.PartIndex = packed[key].(int32)
	}
	return params
}

func decodeDownloadEmailAttachmentPartParams(args [2]string, argsEscaped bool, r *http.Request) (params DownloadEmailAttachmentPartParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
		...
		if len(param) > 0 {
			...
			if err := func() error {
				if err := (validate.Int{
					...
					MultipleOf:    0,
					Pattern:       nil,
				}).Validate(int64(params.PartIndex)); err != nil {
					return errors.Wrap(err, "int")
				}
				return nil
			}(); err != nil {
...
// DownloadSentAttachmentPartParams is parameters of downloadSentAttachmentPart operation.
...
func unpackDownloadSentAttachmentPartParams(packed middleware.Parameters) (params DownloadSentAttachmentPartParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeDownloadSentAttachmentPartParams(args [2]string, argsEscaped bool, r *http.Request) (params DownloadSentAttachmentPartParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
...
// PullWebhookEventParams is parameters of pullWebhookEvent operation.
type PullWebhookEventParams struct {
	// Resource UUID.
	ID uuid.UUID
}

func unpackPullWebhookEventParams(packed middleware.Parameters) (params PullWebhookEventParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodePullWebhookEventParams(args [1]string, argsEscaped bool, r *http.Request) (params PullWebhookEventParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
