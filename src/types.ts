/**
 * Primitive Webhook Event Types
 *
 * This module contains all TypeScript type definitions for Primitive webhook payloads.
 * These types are used for compile-time type checking and IDE autocompletion.
 *
 * @packageDocumentation
 */

import type { WebhookVersion } from "./webhook/version.js";
...
export interface ParsedDataComplete {
  ...
  /**
   * HTML body of the email (sanitized via DOMPurify).
 ...
 *
 * This is delivered to your webhook endpoint when Primitive receives an email
...
export interface EmailReceivedEvent {
  ...
  delivery: {
     ...
     * Matches the endpoint ID from your Primitive dashboard.
     */
    endpoint_id: string;
  ...
  email: {
     ...
     * Use this ID when calling Primitive APIs to reference this email.
     */
    id: string;
 ...
 */
export type SpfResult = (typeof SpfResult)[keyof typeof SpfResult];
 ...
 */
export type DmarcResult = (typeof DmarcResult)[keyof typeof DmarcResult];
 ...
 */
export type DmarcPolicy = (typeof DmarcPolicy)[keyof typeof DmarcPolicy] | null;
 ...
 */
export type DkimResult = (typeof DkimResult)[keyof typeof DkimResult];
 ...
 *
 * Fields marked optional (`selector`, `keyBits`, `algo`) may be unavailable
 * in self-hosted environments where the milter provides limited DKIM detail.
 */
...
export type AuthConfidence =
  (typeof AuthConfidence)[keyof typeof AuthConfidence];
...
export type ForwardVerdict =
  (typeof ForwardVerdict)[keyof typeof ForwardVerdict];
...
/**
 * Result for an inline forward that was detected and analyzed.
 * Inline forwards are always analyzed when forward detection is enabled.
 */
...
/**
 * Result for an attachment forward that was detected but not analyzed.
 * This occurs when attachment analysis is disabled or the limit was reached.
 */
 ...
 *
 * When Primitive adds new event types, your code won't break - you'll receive
 ...
 */
export type ParsedStatus = (typeof ParsedStatus)[keyof typeof ParsedStatus];
