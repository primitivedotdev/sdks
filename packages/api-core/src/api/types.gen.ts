...
export type ClientOptions = {
    baseUrl: 'https://www.primitive.dev/api/v1' | 'https://api.primitive.dev/v1' | 'https://api.primitive.dev/v1' | 'https://www.primitive.dev/api/v1' | 'https://api.primitive.dev/v1' | 'https://www.primitive.dev/api/v1' | 'https://api.primitive.dev/v1' | (string & {});
};
 ...
 */
export type SemanticSearchField = 'subject' | 'headers' | 'addresses' | 'body';
...
export type SemanticSearchSnippet = {
    /**
 ...
 *
 */
export type SemanticSearchScoreBreakdown = {
 ...
 */
export type SemanticSearchCoverage = {
