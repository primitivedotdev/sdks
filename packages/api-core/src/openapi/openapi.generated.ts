...
export const openapiDocument: Record<string, unknown> = {
  ...
  "tags": [
    ...
    {
      "name": "Routes",
      "description": "Recipient routing rules. Each route binds a recipient pattern (an exact\naddress, or a wildcard) to one endpoint; inbound mail resolves to a single\ndestination at delivery time. Routes let different addresses on the same\ndomain reach different endpoints.\n"
    },
    {
      "name": "Filters",
  ...
  "paths": {
    ...
    "/routes/reorder": {
      "post": {
        ...
        "responses": {
          "200": {
            "description": "The updated routes, in evaluation order",
            "content": {
              "application/json": {
                "schema": {
                  "allOf": [
