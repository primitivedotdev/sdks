    ...
    "/cli/signup/resend": {
      "post": {
        ...
        "responses": {
          ...
          "400": {
            "description": "Invalid token, expired token, or resend requested too quickly",
            "headers": {
              "Retry-After": {
                "schema": {
                  "type": "integer"
                },
                "description": "Seconds to wait before requesting another code when the error code is `slow_down`"
              }
            },
            "content": {
              "application/json": {
