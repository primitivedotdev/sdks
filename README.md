...
| --- | --- | --- |
| Node.js | `npm install primitivedotdev` | `sdk-node/README.md` |
...
The Node SDK also ships Node-only `contract` and `parser` modules under `primitivedotdev/contract` and `primitivedotdev/parser`.
