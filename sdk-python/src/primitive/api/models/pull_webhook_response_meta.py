...
T = TypeVar("T", bound="PullWebhookResponseMeta")



@_attrs_define
class PullWebhookResponseMeta:
    """ 
        Attributes:
            total (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pull_webhook_response_meta = cls(
            total=total,
        ...
        pull_webhook_response_meta.additional_properties = d
        return pull_webhook_response_meta
