...
T = TypeVar("T", bound="TemplateRegistrySummary")



@_attrs_define
class TemplateRegistrySummary:
    """ 
        Attributes:
            id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        template_registry_summary.additional_properties = d
        return template_registry_summary
