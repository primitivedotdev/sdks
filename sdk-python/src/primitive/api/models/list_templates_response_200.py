...
if TYPE_CHECKING:
  from ..models.template_registry_page import TemplateRegistryPage
...
class ListTemplatesResponse200:
    """ 
        Attributes:
            success (bool):
            data (TemplateRegistryPage | Unset):
     """

    success: bool
    data: TemplateRegistryPage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data,  Unset):
            ...
            data = TemplateRegistryPage.from_dict(_data)
