...
T = TypeVar("T", bound="CliSignupResendResult")



@_attrs_define
class CliSignupResendResult:
    """ 
        Attributes:
            email (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cli_signup_resend_result.additional_properties = d
        return cli_signup_resend_result
