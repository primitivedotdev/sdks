...
T = TypeVar("T", bound="EmailSearchResult")
...
class EmailSearchResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_highlights,  Unset):
            ...
            highlights = EmailSearchHighlights.from_dict(_highlights)




        email_search_result = cls(
            id=id,
            status=status,
            sender=sender,
            recipient=recipient,
        ...
        email_search_result.additional_properties = d
