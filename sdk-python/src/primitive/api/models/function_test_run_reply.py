...
T = TypeVar("T", bound="FunctionTestRunReply")



@_attrs_define
class FunctionTestRunReply:
    """ 
        Attributes:
            id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        function_test_run_reply.additional_properties = d
        return function_test_run_reply
