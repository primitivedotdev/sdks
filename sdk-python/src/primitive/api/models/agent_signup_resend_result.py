...
T = TypeVar("T", bound="AgentSignupResendResult")



@_attrs_define
class AgentSignupResendResult:
    """ 
        Attributes:
            email (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_signup_resend_result = cls(
            email=email,
            expires_in=expires_in,
            resend_after=resend_after,
            verification_code_length=verification_code_length,
        ...
        agent_signup_resend_result.additional_properties = d
        return agent_signup_resend_result
