...
T = TypeVar("T", bound="CreateFunctionInputFiles")



@_attrs_define
class CreateFunctionInputFiles:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        create_function_input_files = cls(
        )


        create_function_input_files.additional_properties = d
        return create_function_input_files
