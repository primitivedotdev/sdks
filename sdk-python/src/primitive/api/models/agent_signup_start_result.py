...
T = TypeVar("T", bound="AgentSignupStartResult")



@_attrs_define
class AgentSignupStartResult:
    """ 
        Attributes:
            signup_token (str): Opaque token used to verify or resend the pending agent signup
            email (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_signup_start_result.additional_properties = d
        return agent_signup_start_result
