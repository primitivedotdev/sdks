...
T = TypeVar("T", bound="CreateEmailChallengeResponse201")



@_attrs_define
class CreateEmailChallengeResponse201:
    """ 
        Attributes:
            success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_email_challenge_response_201 = cls(
            success=success,
            data=data,
        )


        create_email_challenge_response_201.additional_properties = d
        return create_email_challenge_response_201
