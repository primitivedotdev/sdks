...
T = TypeVar("T", bound="CreateFunctionSecretResponse201")



@_attrs_define
class CreateFunctionSecretResponse201:
    """ 
        Attributes:
            success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_function_secret_response_201 = cls(
            success=success,
            data=data,
        )


        create_function_secret_response_201.additional_properties = d
        return create_function_secret_response_201
