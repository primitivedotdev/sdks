...
class MemoryRecord:
    ...
    `include_value=false`.
        ...
        Attributes:
            ...
            value (bool | float | list[Any] | MemoryJsonValueType5 | None | str | Unset): JSON value accepted by Primitive
                Memories. The server accepts strings,
    ...
    created_by: None | str
    updated_by: None | str
    value: bool | float | list[Any] | MemoryJsonValueType5 | None | str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> bool | float | list[Any] | MemoryJsonValueType5 | None | str | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(bool | float | list[Any] | MemoryJsonValueType5 | None | str | Unset, data)
