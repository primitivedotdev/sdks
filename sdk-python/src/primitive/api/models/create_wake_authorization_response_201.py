...
T = TypeVar("T", bound="CreateWakeAuthorizationResponse201")



@_attrs_define
class CreateWakeAuthorizationResponse201:
    """ 
        Attributes:
            success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wake_authorization_response_201 = cls(
            success=success,
            data=data,
        )


        create_wake_authorization_response_201.additional_properties = d
        return create_wake_authorization_response_201
