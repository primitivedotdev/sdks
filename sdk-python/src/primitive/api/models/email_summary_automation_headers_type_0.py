...
T = TypeVar("T", bound="EmailSummaryAutomationHeadersType0")



@_attrs_define
class EmailSummaryAutomationHeadersType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        email_summary_automation_headers_type_0 = cls(
        ...
        email_summary_automation_headers_type_0.additional_properties = d
        return email_summary_automation_headers_type_0
