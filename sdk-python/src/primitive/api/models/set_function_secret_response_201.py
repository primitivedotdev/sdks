...
T = TypeVar("T", bound="SetFunctionSecretResponse201")



@_attrs_define
class SetFunctionSecretResponse201:
    """ 
        Attributes:
            success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_function_secret_response_201 = cls(
            success=success,
            data=data,
        )


        set_function_secret_response_201.additional_properties = d
        return set_function_secret_response_201
